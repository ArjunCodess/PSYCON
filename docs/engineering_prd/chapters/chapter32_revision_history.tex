...
v1.8 & Added the Week 7 candidate freeze, release integrity tooling, operating package, verified references, final evidence matrix, and demonstration procedure \\
\bottomrule
\end{tabularx}
\end{table}
