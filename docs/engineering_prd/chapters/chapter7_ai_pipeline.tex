...
\textbf{Speech.} Speech is collected continuously. \Cref{fig:speech-pipeline} shows the speech acquisition pipeline.
...
\begin{warningbox}
For privacy, avoid storing raw audio longer than necessary unless explicit user consent and a clear research need are established.
\end{warningbox}
