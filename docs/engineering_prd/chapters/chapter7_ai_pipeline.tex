...
The completed Week 3 software implements a deterministic mono PCM16 extractor named \texttt{psycon\_audio\_v2}. Its ordered feature vector contains duration, RMS and peak dBFS, clipping fraction, DC offset, zero-crossing rate, spectral centroid, 85\% spectral rolloff, spectral flatness, mean/standard-deviation/minimum/maximum autocorrelation pitch from 70--400~Hz, relative pitch jitter, bounded voice stability, energy-active frame fraction, pause count, and pause duration. This version has no downloaded-model or third-party feature-extractor dependency. Incompatible feature changes require a new extractor version and equivalence tests.
